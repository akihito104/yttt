...
private fun onAir(actualStartDateTime: Instant): LiveTimelineItem = mockk<LiveTimelineItem>().apply {
    every { this@apply.dateTime } returns actualStartDateTime
}
